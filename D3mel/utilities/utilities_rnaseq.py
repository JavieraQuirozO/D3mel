...
class UtilitiesRNAseq():
    ...
    """
    def __init__(self, rpkm):
        self.Seq_Gene_Expression = rpkm
    ...
    def RNA_by_proyect(self, g, proyects, matriz = None):
        ...
        try:
            ...
            for proyect in proyects:
                df = matriz[matriz['Parent_library_name'] == proyect].copy()
                df['RPKM_value'] = pd.to_numeric(df['RPKM_value'], errors='coerce')
